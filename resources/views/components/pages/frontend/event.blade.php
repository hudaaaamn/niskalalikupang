<x-layouts.visitor-layout>
    ...
    <div class="pt-30 ">
        <section class="mb-6 bg-black-1">
            <div class="grid py-20 mx-auto md:grid-cols-3 max-w-7xl">
                <div class="pl-10 mb-8 space-y-10 text-white text-balance ">
                    <h1 class="text-3xl font-extrabold font-inter">Info Acara Terbaru</h1>
                    <p class="w-3/4 font-inter text-justify">
                        Informasi terbaru dan terlengkap tentang berbagai acara menarik di tempat wisata Likupang.
                        Temukan
                        ...
                        Likupang
                        Mari jadikan momen liburan Anda di Likupang semakin berkesan dengan mengikuti berbagai acara
                        seru
                        yang tersedia.
                    </p>
            ...
            <form class="max-w-md px-10 mx-auto my-10" action="{{ route('events') }}" method="GET">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="keyword" id="default-search"
                        class="block w-full p-4 text-sm text-gray-900 border border-gray-300 rounded-lg ps-10 bg-gray-50 focus:ring-blue-500 focus:border-green-new dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Cari Acara..." required />
                    <button type="submit"
                        class="text-white absolute font-inter end-2.5 bottom-2.5 bg-blue-500 hover:bg-opacity-90 focus:ring-4 focus:outline-none focus:ring-green-new font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Cari</button>
                </div>
            </form>
